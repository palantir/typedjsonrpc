...
def test_dispatch_invalid_request_wrong_jsonrpc():
    registry = Registry()
...
def test_dispatch_invalid_request_no_method():
    registry = Registry()
...
def test_dispatch_invalid_request_float_id():
    registry = Registry()
...
def test_dispatch_invalid_request_no_jsonrpc():
    registry = Registry()
